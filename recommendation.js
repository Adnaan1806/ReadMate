document.addEventListener("DOMContentLoaded", function () {
        ...
        .then(data => {
            ...
            data.books_by_author.forEach(book => {
                ...
                if (book.collection === true) {
                    createCollectionSlide({ image: book['Image-URL-S'], title: book['Book-Title'] });
                } else {
                    createFeaturedBookSlide({ image: book['Image-URL-S'], title: book['Book-Title'] });
                }
            });
    ...
    document.getElementById('bookForm').addEventListener('submit', function(event) {
        ...
        var bookName = document.getElementById('bookName').value; // Get the value of book name input
        fetchRecommendations(bookName);
    });
});
